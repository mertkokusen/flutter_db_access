...
import 'package:database_access_layer/entity/cus/customer_note.dart';

// GENERATED CODE - DO NOT MODIFY BY HAND
class CustomerNote extends CustomerNoteAbstract{
  int idCustomerNote;
  DateTime dtUpdate;
  int idUser;
  int idCustomer;
  ...
  static CustomerNote fromMap(Map<String, dynamic> json) {
    return CustomerNote()
